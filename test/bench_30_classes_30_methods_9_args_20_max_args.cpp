...
MOCK_BASE_CLASS(mock_class_1, base_class){
  MOCK_METHOD(f1, 9) MOCK_METHOD(f2, 9) MOCK_METHOD(f3, 9) MOCK_METHOD(f4, 9) MOCK_METHOD(f5, 9) MOCK_METHOD(f6, 9)
    MOCK_METHOD(f7, 9) MOCK_METHOD(f8, 9) MOCK_METHOD(f9, 9) MOCK_METHOD(f10, 9) MOCK_METHOD(f11, 9) MOCK_METHOD(f12, 9)
      MOCK_METHOD(f13, 9) MOCK_METHOD(f14, 9) MOCK_METHOD(f15, 9) MOCK_METHOD(f16, 9) MOCK_METHOD(f17, 9)
        MOCK_METHOD(f18, 9) MOCK_METHOD(f19, 9) MOCK_METHOD(f20, 9) MOCK_METHOD(f21, 9) MOCK_METHOD(f22, 9)
          MOCK_METHOD(f23, 9) MOCK_METHOD(f24, 9) MOCK_METHOD(f25, 9) MOCK_METHOD(f26, 9) MOCK_METHOD(f27, 9)
            MOCK_METHOD(f28, 9) MOCK_METHOD(f29, 9) MOCK_METHOD(f30, 9)};
